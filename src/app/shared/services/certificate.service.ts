      ...
      "content": [
          ...
          "columns": [
            {
              "text": [
                ...
                {
                  "text": "\n\nTHE AFORESAID VEHICLE HAS BEEN CHECKED/TESTED FOR OPERATING SPEED LIMIT AS PER DELHI GAZETTE NOTIFICATION F.NO. MLO(VIU)/TPT/20147/165/315 DATED 17.07.2018 AND SUBSEQUENT CIRCULAR ISSUED BY TRANSPORT DEPARTMENT. IT IS CERTIFIED THAT THE VEHICLE HAS PASSED THE TEST AND IS NOT RUNNING MORE THAN 80KM/HR SPEED AS PER THE PERMIT CONDITION i.e. __________________",
                  "alignment": "justify",
                  "fontSize": "9"
                },
                {
        ...
        },
        {
          "text": [
            ...
            {
              "text": "\nI have checked the function of Speed Governor and its sealing. I am satisfied with the Speed Limit test. I undertake that I will not tamper with Speed Governor or the seal.",
              "alignment": "justify"
            },
            {
            ...
            {
              "text": "\n\nNote:- The vehicle should be produced for grant or renewal of Certificate of fitness within 15 days of issurance of this certificate.",
              "bold": true,
              "alignment": "justify",
              "decoration": "underline"
            }
        ...
        {
          "ol": [
            "THE DRIVER OF MOTOR VEHICLE WILL NOT TAMPER THE SPEED GOVERNOR IN ANY CIRCUMSTANCES. IN CASE, SPEED GOVERNOR OR ROTO SEAL OF THE VEHICLE IS FOUND TAMPERED WITH, IT SHALL BE PUNISHABLE UNDER THE PROVISIONS OF PERMIT CONDITION UNDER SECTION 66/192A OF MV ACT, 1988, WHICH MAY EXTEND TO IMPOUNDING OF VEHICLE AND CAN ALSO EXTEND TO IMPRISONMENT OF THE DRIVER OR THE OWNER OF THE VEHICLE.",
            "WHENEVER THE DRIVER/OWNER FINDS THAT THE VEHICLE IS RUNNING BEYOND PRESCRIBED SPEED LIMITS. IT MUST BE REPAIRED IMMEDIATELY FROM VEHICLE MANUFACTURER OF ITS AUTHORISED REPRESENTATIVE, AFTER OBTAINING PRIOR PERMISSION FROM VEHICLE INSPECTION UNIT BURARI, FAILING WHICH ACTION u/s 66 OF MV ACT, 1988 WILL BE TAKEN. THE DRIVER/OWNER CANNOT USE HIS VEHICLE FOR HIRE-REWARD PURPOSE WHEN THE SPEED GOVERNOR IS NOT FUNCTIONING OR IS DEFECTIVE.",
            "THE DRIVER/OWNER MUST TAKE ALL POSSIBLE PREVENTION TO PROTECT THE SPEED GOVERNOR MECHANISM DURING THE OPERATION OF VEHICLE OR REPAIRING FOR OTHER ASSEMBLES e.g. GEAR BOX, CLUTCH, ENGINE OR UNDER CARRIAGE."
          ],
          "bold": true,
          "alignment": "justify",
          "margin": [
        ...
        {
          "ul": [
            "मोटर वाहन का चालक किसी भी परिस्थिती में स्पीड त्रावर्लर जहींछेडछाड कोआ । मामले में, वाहन के स्पीड त्राबर्लर जा रौटो सील के खाद्य छेडछाड ठी त्रार्द्ध जाई है, यह श्रीश ३६/१९१ ए के तहत अनुमति शर्तों के प्रावधानों के तहत निर्विवाद होया, यदि एमवी उधिजिद्धम, है के ८८, जो कि वाहन ठी जब्त अले के लिए विस्तारित हो मलता है भी या भी समाप्त हो सकता है वाहन जो नकल और वाहन के मालिक ठी जब्त के लिए भी विस्तारित है ।",
            "जव भी चालक / मालिक पता चलता है कि वाहन क्योंड सिमित सीमाओं से आने बद रहा है । इसे अपने अधिकृत प्रतिनिधियों के वाहन निर्माता से तत्काल मरम्मत ठी जाली चाहिए, वाहन निरीक्षण युनिट बुरी से प्राथमिक अनुमति प्राप्त ठाले के जाव, एमएबी उशिजिद्धम, ८३ के तहत ठायंटाही ठी कास्तार्द होओ । चालक/स्वामी अपने रिवाड प्रयोजन के लिए अपने वाहन का उपयोग नहीं का सकते है जव ज्योंड बावजी बम नहीं ठा यहा है जा दोषपूर्ग है ।",
            "चालक/मालिक को वाहन के संचालन जा अन्य सहयोगियों के लिए मरम्मत के दौरान क्योंड डावर्लर र्मकेनिजम ठी सुरक्षा के लिए अभी संमावित शेमद्याम करजा होआ । शिखा बाँक्स, क्लच, इंजन जा केरीज के तहत ।"
          ],
          "bold": true,
          "alignment": "justify"
        }
