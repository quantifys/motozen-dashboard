...
@Component({
  selector: 'app-salary-slip-filter',
  templateUrl: './salary-slip-filter.component.html',
  styleUrls: ['./salary-slip-filter.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS }
  ]
})
export class SalarySlipFilterComponent implements OnInit {
  ...
  constructor(
    ...
    private bottomSheetRef: MatBottomSheetRef<SalarySlipFilterComponent>
  ) {
    this._store.dispatch(new salarySlipActions.FetchSalarySlipFilterFormDataAction);
  }
